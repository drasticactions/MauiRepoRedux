...
namespace Drastic.TrayWindow
{
    ...
    internal class UINSWindow
    {
        ...
        public void PerformWindowDrag()
        {
            ...
            var currentEvent = Drastic.Interop.ObjC.Call(sharedApplication.Handle, "currentEvent");
            ObjC.Call(this.NSWindow.Handle, "performWindowDragWithEvent:", currentEvent);
        }
