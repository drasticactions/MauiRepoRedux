...
public static class MauiProgram
{
	public static MauiApp CreateMauiApp()
	{
		...
		// Microsoft.Maui.Handlers.PageHandler.ViewMapper.AppendToMapping("Test", async (handler, view) =>
		// {
		...
		// 	var window = (UIWindow)Microsoft.Maui.Controls.Application.Current.Windows[0].Handler.PlatformView;
		...
		// 	}
		//
		// 	var attachedWindow = nsWindow.NSWindow.PerformSelector(new Selector("attachedWindow"))!;
		// 	ObjC.Call(attachedWindow.Handle, "setOpaque:", false);
		...
		// 	//var contentView = contentViewController.PerformSelector(new Selector("view"))!;
		// 	ObjC.Call(contentView.Handle, "addSubview:positioned:relativeTo:", item.Handle, -1, IntPtr.Zero);
		// });
		// Microsoft.Maui.Handlers.WindowHandler.Mapper.AppendToMapping("WindowChange", async (handler, view) =>
		// {
		// 	var item = Runtime.GetNSObject(AppKit.Call("NSVisualEffectView", "alloc"))!;
		// 	ObjC.Call(item.Handle, "initWithFrame:", UIScreen.MainScreen.Bounds);
		// 	ObjC.Call(item.Handle, "setMaterial:", 21);
		...
		// 	ObjC.Call(item.Handle, "setWantsLayer:", true);
		//
		// 	var nsWindow = await (handler.PlatformView).ToUINSWindowAsync();
		// 	if (nsWindow is null)
		// 	{
		// 		return;
		// 	}
		...
		// 	//var contentViewController = attachedWindow.PerformSelector(new Selector("contentViewController"))!;
		// 	//var contentView = contentViewController.PerformSelector(new Selector("view"))!;
		// 	//ObjC.Call(contentView.Handle, "addSubview:positioned:relativeTo:", item.Handle, -1, IntPtr.Zero);
		// });
		builder
